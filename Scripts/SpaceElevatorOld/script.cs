...
namespace SpaceEngineers.UWBlockPrograms.SpaceElevatorOld {
...
public void Main(string argument, UpdateType updateSource) {
    ...
    switch (speLastArg) {
        ...
        case "Stop":
            cockpit.HandBrake = true;
            propulsion = (float)(cockpit.CalculateShipMass().PhysicalMass * cockpit.GetNaturalGravity().Length() / 7500000);
            break;
    }
